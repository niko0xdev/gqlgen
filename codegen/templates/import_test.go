...
func TestImports(t *testing.T) {
	...
	aBar := "github.com/niko0xdev/gqlgen/codegen/templates/testdata/a/bar"
	bBar := "github.com/niko0xdev/gqlgen/codegen/templates/testdata/b/bar"
	mismatch := "github.com/niko0xdev/gqlgen/codegen/templates/testdata/pkg_mismatch"
	...
	t.Run("lookup by type", func(t *testing.T) {
		...
		pkg := types.NewPackage("github.com/niko0xdev/gqlgen/codegen/templates/testdata/b/bar", "bar")
	...
	t.Run("duplicates above 10 are decollisioned", func(t *testing.T) {
		a := Imports{destDir: wd, packages: code.NewPackages()}
		for i := 0; i < 100; i++ {
			cBar := fmt.Sprintf("github.com/niko0xdev/gqlgen/codegen/templates/testdata/%d/bar", i)
			if i > 0 {
	...
	t.Run("string printing for import block", func(t *testing.T) {
		...
		require.Equal(
			t,
			`"github.com/niko0xdev/gqlgen/codegen/templates/testdata/a/bar"
bar1 "github.com/niko0xdev/gqlgen/codegen/templates/testdata/b/bar"
turtles "github.com/niko0xdev/gqlgen/codegen/templates/testdata/pkg_mismatch"`,
			a.String(),
		)
	})
	...
	t.Run("aliased imports will not collide", func(t *testing.T) {
		...
		require.Equal(t, `abar "github.com/niko0xdev/gqlgen/codegen/templates/testdata/a/bar"
bbar "github.com/niko0xdev/gqlgen/codegen/templates/testdata/b/bar"`, a.String())
	})
}
