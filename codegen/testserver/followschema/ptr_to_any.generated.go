...
func (ec *executionContext) marshalNPtrToAnyContainer2githubᚗcomᚋniko0xdevᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐPtrToAnyContainer(ctx context.Context, sel ast.SelectionSet, v PtrToAnyContainer) graphql.Marshaler {
	return ec._PtrToAnyContainer(ctx, sel, &v)
}

func (ec *executionContext) marshalNPtrToAnyContainer2ᚖgithubᚗcomᚋniko0xdevᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐPtrToAnyContainer(ctx context.Context, sel ast.SelectionSet, v *PtrToAnyContainer) graphql.Marshaler {
	if v == nil {
