...
func (ec *executionContext) marshalOVariadicModel2ᚖgithubᚗcomᚋniko0xdevᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐVariadicModel(ctx context.Context, sel ast.SelectionSet, v *VariadicModel) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
