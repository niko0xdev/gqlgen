...
import (
	...
	"github.com/niko0xdev/gqlgen/codegen"
	"github.com/niko0xdev/gqlgen/codegen/config"
	"github.com/niko0xdev/gqlgen/codegen/templates"
	"github.com/niko0xdev/gqlgen/plugin"
	"github.com/niko0xdev/gqlgen/plugin/federation/fieldset"
)
	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/niko0xdev/gqlgen/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/niko0xdev/gqlgen/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/niko0xdev/gqlgen/graphql.Map"},
		},
		"federation__Scope": {
			Model: config.StringList{"github.com/niko0xdev/gqlgen/graphql.String"},
		},
	}
