...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/niko0xdev/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func TestOmitTemplateComment(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/niko0xdev/gqlgen/plugin/resolvergen/testdata/omit_template_comment/out")
}
...
func TestResolver_Implementation(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/niko0xdev/gqlgen/plugin/resolvergen/testdata/resolver_implementor/out")
}
...
func testFollowSchemaPersistence(t *testing.T, dir string) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/niko0xdev/gqlgen/plugin/resolvergen/"+dir+"/out")
}
